...
public class Bari_Household_Visit_DataModel {
       ...
       public List<Bari_Household_Visit_DataModel> SelectAll(Context context, String SQL)
       {
           Connection C = new Connection(context);
           List<Bari_Household_Visit_DataModel> data = new ArrayList<Bari_Household_Visit_DataModel>();
           Bari_Household_Visit_DataModel d = new Bari_Household_Visit_DataModel();
           Cursor cur = C.ReadData(SQL);

           cur.moveToFirst();
           while(!cur.isAfterLast())
           {
               d = new Bari_Household_Visit_DataModel();
