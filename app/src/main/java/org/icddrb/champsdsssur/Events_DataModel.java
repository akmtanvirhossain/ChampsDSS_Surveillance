...
import android.content.Context;
 ...
 public class Events_DataModel{
     ...
     public String TransactionSQL(Context context)
     {
        ...
        public List<Events_DataModel> SelectAll(Context context, String SQL)
        {
            Connection C = new Connection(context);
            List<Events_DataModel> data = new ArrayList<Events_DataModel>();
