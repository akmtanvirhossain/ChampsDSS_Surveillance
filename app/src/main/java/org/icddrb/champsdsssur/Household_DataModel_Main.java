...
public class Household_DataModel_Main {
       ...
       public List<Household_DataModel_Main> SelectAll(Context context, String SQL)
    {
        Connection C = new Connection(context);
        List<Household_DataModel_Main> data = new ArrayList<Household_DataModel_Main>();
        Household_DataModel_Main d = new Household_DataModel_Main();
        Cursor cur = C.ReadData(SQL);

        cur.moveToFirst();
        while(!cur.isAfterLast())
        {
            d = new Household_DataModel_Main();
    ...
    public List<Household_DataModel_Main> SelectAllVisit(Context context, String SQL)
    {
        Connection C = new Connection(context);
        List<Household_DataModel_Main> data = new ArrayList<Household_DataModel_Main>();
        Household_DataModel_Main d = new Household_DataModel_Main();
