...
public class MainMenu_QA extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            setContentView(R.layout.main_menu_qa);
            ...
            */
            ...
            cmdHHInterview.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    sp.save(MainMenu_QA.this,"cluster",spnCluster.getSelectedItem().toString());
                    sp.save(MainMenu_QA.this,"block",spnBlock.getSelectedItem().toString());
                    sp.save(MainMenu_QA.this,"roundno",spnRound.getSelectedItem().toString());
            ...
            cmdDataSync.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    ...
                    if (Connection.haveNetworkConnection(MainMenu_QA.this)) {
                    } else {
                        Connection.MessageBox(MainMenu_QA.this, "ডেটা সিঙ্ক করার জন্য  ইন্টারনেট সংযোগ নাই.");
                        return;
                    }

                    AlertDialog.Builder adb = new AlertDialog.Builder(MainMenu_QA.this);
                    adb.setTitle("Data Sync");
                    adb.setMessage("আপনি ডেটা সিঙ্ক করতে চান[হ্যাঁ/না]?");
                    adb.setNegativeButton("না", null);
                    adb.setPositiveButton("হ্যাঁ", new AlertDialog.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            C = new Connection(MainMenu_QA.this);
                            //final ProgressDialog progDailog = ProgressDialog.show(MainMenu.this, "", "Please Wait . . .", true);
                            progDailog = new ProgressDialog(MainMenu_QA.this);
                                ...
                                public void run() {
                                    try {
                                        ...
                                        if(!isMyServiceRunning(Sync_Service.class)) {
                                            Intent syncService = new Intent(MainMenu_QA.this, Sync_Service.class);
                ...
                public void onClick(View view) {
                    ...
                    adb.setPositiveButton("হ্যাঁ", new AlertDialog.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Intent gpsService = new Intent(MainMenu_QA.this, GPSService.class);
        ...
        {
            Connection.MessageBox(MainMenu_QA.this,ex.getMessage());
        }
    }
