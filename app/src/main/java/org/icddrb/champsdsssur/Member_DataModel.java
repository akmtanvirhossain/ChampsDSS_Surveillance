...
import android.content.Context;
 ...
 public class Member_DataModel{
     ...
     public List<Member_DataModel> SelectAll_MigMember(Context context, String SQL)
     {
