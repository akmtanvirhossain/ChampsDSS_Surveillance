...
public class MigrationMember_DataModel {
    ...
    public String TransactionSQL(Context context)
    {
       ...
       private String SaveData(Context context)
       {
           ...
           try
             {
                SQL = "Insert into "+ TableName +" (Vill,Bari,HH,MSlNo,PNo,Name,Rth,Sex,BDate,AgeY,MoNo,FaNo,Edu,MS,Pstat,LmpDt,Ocp,Sp1,Sp2,Sp3,Sp4,EnType,EnDate,ExType,ExDate,DeviceID,EntryUser)Values('"+ _Vill +"', '"+ _Bari +"', '"+ _HH +"', '"+ _MSlNo +"', '"+ _PNo +"', '"+ _Name +"', '"+ _Rth +"', '"+ _Sex +"', '"+ _BDate +"', '"+ _AgeY +"', '"+ _MoNo +"', '"+ _FaNo +"', '"+ _Edu +"', '"+ _MS + "', '"+ _Pstat +  "', '"+ _LmpDt +"', '"+ _Ocp +"', '"+ _Sp1 +"', '"+ _Sp2 +"', '"+ _Sp3 +"', '"+ _Sp4 +"', '"+ _EnType +"', '"+ _EnDate +"', '"+ _ExType +"', '"+ _ExDate + "','"+ _DeviceID +"', '"+ _EntryUser +"')";
                C.Save(SQL);
                C.close();
             }
             catch(Exception  e)
       ...
       public List<MigrationMember_DataModel> SelectAll(Context context, String SQL)
       {
           Connection C = new Connection(context);
           List<MigrationMember_DataModel> data = new ArrayList<MigrationMember_DataModel>();
           MigrationMember_DataModel d = new MigrationMember_DataModel();
           Cursor cur = C.ReadData(SQL);

           cur.moveToFirst();
           while(!cur.isAfterLast())
           {
               d = new MigrationMember_DataModel();
