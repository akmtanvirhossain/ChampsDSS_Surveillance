...
public class MigrationPregHis_DataModel {
    ...
    public String TransactionSQL(Context context)
    {
       ...
       public List<MigrationPregHis_DataModel> SelectAll(Context context, String SQL)
       {
           Connection C = new Connection(context);
           List<MigrationPregHis_DataModel> data = new ArrayList<MigrationPregHis_DataModel>();
           MigrationPregHis_DataModel d = new MigrationPregHis_DataModel();
           Cursor cur = C.ReadData(SQL);

           cur.moveToFirst();
           while(!cur.isAfterLast())
           {
               d = new MigrationPregHis_DataModel();
