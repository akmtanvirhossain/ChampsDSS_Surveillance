...
public class PregHis_DataModel_Main {
    ...
    public String getEnDt(){
       ...
       public List<PregHis_DataModel_Main> SelectAll(Context context, String SQL)
       {
           Connection C = new Connection(context);
           List<PregHis_DataModel_Main> data = new ArrayList<PregHis_DataModel_Main>();
           PregHis_DataModel_Main d = new PregHis_DataModel_Main();
           Cursor cur = C.ReadData(SQL);

           cur.moveToFirst();
           while(!cur.isAfterLast())
           {
               d = new PregHis_DataModel_Main();
