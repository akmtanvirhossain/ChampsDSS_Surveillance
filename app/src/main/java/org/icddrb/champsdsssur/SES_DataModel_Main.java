...
public class SES_DataModel_Main {
    ...
    public void setEnDt(String newValue){ _EnDt = newValue; }
       ...
       public List<SES_DataModel_Main> SelectAll(Context context, String SQL)
       {
           Connection C = new Connection(context);
           List<SES_DataModel_Main> data = new ArrayList<SES_DataModel_Main>();
           SES_DataModel_Main d = new SES_DataModel_Main();
           Cursor cur = C.ReadData(SQL);

           cur.moveToFirst();
           while(!cur.isAfterLast())
           {
               d = new SES_DataModel_Main();
