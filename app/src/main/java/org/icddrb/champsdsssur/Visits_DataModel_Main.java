...
public class Visits_DataModel_Main {
    ...
    public String getLon(){
       ...
       public List<Visits_DataModel_Main> SelectAll(Context context, String SQL)
       {
           Connection C = new Connection(context);
           List<Visits_DataModel_Main> data = new ArrayList<Visits_DataModel_Main>();
           Visits_DataModel_Main d = new Visits_DataModel_Main();
           Cursor cur = C.ReadData(SQL);

           cur.moveToFirst();
           while(!cur.isAfterLast())
           {
               d = new Visits_DataModel_Main();
